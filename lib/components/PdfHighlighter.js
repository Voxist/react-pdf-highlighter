...
var _pdf_single_page_viewer = require("pdfjs-dist/lib/web/pdf_single_page_viewer");
...
var PdfHighlighter = function (_PureComponent) {
  ...
  function PdfHighlighter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.state = {
      ...
      console.log(pageNumber, typeof pageNumber === "undefined" ? "undefined" : _typeof(pageNumber));

      if (pageNumber > 1) {
        if (_this.viewer.viewer && _this.viewer.viewer.childNodes && _this.viewer.viewer.childNodes.length > 1) {
          for (var _index = 1; _index < _this.viewer.viewer.childNodes.length; _index++) {
            var element = _this.viewer.viewer.childNodes[_index];
            // $FlowFixMe
            element.remove();
          }
        }
        _this.viewer.currentPageNumber = pageNumber;
      }
  ...
  PdfHighlighter.prototype.componentDidMount = function componentDidMount() {
    ...
    var _props = this.props,
        pdfDocument = _props.pdfDocument,
    ...
    this.viewer = new _pdf_single_page_viewer.PDFSinglePageViewer({
  ...
  PdfHighlighter.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    if (nextProps.pageNumber !== this.props.pageNumber) {
      if (this.viewer.viewer && this.viewer.viewer.childNodes && this.viewer.viewer.childNodes.length > 1) {
        for (var _index2 = 1; _index2 < this.viewer.viewer.childNodes.length; _index2++) {
          var element = this.viewer.viewer.childNodes[_index2];
          // $FlowFixMe
          element.remove();
        }
      }
  ...
  PdfHighlighter.prototype.render = function render() {
    ...
    var _props2 = this.props,
        onSelectionFinished = _props2.onSelectionFinished,
        enableAreaSelection = _props2.enableAreaSelection;
